...
class TestSecurity(TestSetUp):
    def setUp(self):
        ...
        self.detail_url = reverse('profissional-detail', kwargs={'pk': self.prof.id})
    ...
    def test_should_deny_list_profissionais_without_token(self):
        ...
        self.assertEqual(res.data['detail'], "As credenciais de autenticação não foram fornecidas.")
    ...
    def test_should_deny_create_profissional_without_token(self):
        ...
        res = self.client.post(self.list_url, self.profissional_data, format='json')
    ...
    def test_should_deny_update_profissional_without_token(self):
        ...
        self.client.credentials()
        res = self.client.patch(self.detail_url, {"nome_social": "Invasor"}, format='json')
    ...
    def test_should_deny_access_with_invalid_token(self):
        ...
        self.client.credentials(HTTP_AUTHORIZATION='Bearer token_totalmente_errado')
        res = self.client.get(self.list_url)
