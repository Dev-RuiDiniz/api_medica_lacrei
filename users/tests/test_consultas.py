...
class TestConsultaViews(TestSetUp):
    ...
    def test_can_create_consulta_vincular_profissional(self):
        ...
        self.assertEqual(res.status_code, 201, msg=f"Erro retornado: {res.data}")
    ...
    def test_delete_profissional_cascade_behavior(self):
        ...
        self.assertFalse(exists, "A consulta deveria ter sido removida em cascata.")
    ...
    def test_update_consulta_status(self):
        ...
        self.assertEqual(res.status_code, 200, msg=f"Erro retornado: {res.data}")
    ...
    def test_cannot_schedule_in_past(self):
        ...
        self.assertTrue('data_hora' in str(res.data) or 'non_field_errors' in res.data)